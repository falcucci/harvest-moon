...
use xcm_builder::TakeWeightCredit;
use xcm_builder::TrailingSetTopicAsId;
...
/// This is used when determining ownership of accounts for asset transacting
/// and when attempting to use XCM `Transact` in order to determine the dispatch
/// Origin.
